...
export function SpecificationsTable() {
  ...
  const specsUIProps = useMemo(() => {
    return {
      ...
      enquiryId: specsUIContext.enquiryId,
    };
  }, [specsUIContext]);
  ...
  useEffect(() => {
    specsUIProps.setIds([]);
    dispatch(
      actions.fetchSpecifications(specsUIProps.queryParams,specsUIProps.enquiryId)
    );
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [specsUIProps.queryParams, dispatch, specsUIProps.enquiryId]);
