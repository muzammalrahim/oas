...
export function RemarksTable() {
  ...
  const remarksUIProps = useMemo(() => {
    return {
      ...
      categoryId: remarksUIContext.categoryId,
  ...
  useEffect(() => {
    ...
    dispatch(
      actions.fetchRemarks(remarksUIProps.queryParams, remarksUIProps.categoryId)
    );
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [remarksUIProps.queryParams, dispatch, remarksUIProps.categoryId]);
  const columns = [
    {
      dataField: "id",
      text: "ID",
