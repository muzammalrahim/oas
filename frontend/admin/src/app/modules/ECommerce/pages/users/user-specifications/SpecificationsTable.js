...
export function SpecificationsTable() {
  ...
  const specsUIProps = useMemo(() => {
    return {
      ...
      categoryId: specsUIContext.categoryId,
    };
  }, [specsUIContext]);
  ...
  useEffect(() => {
    specsUIProps.setIds([]);
    dispatch(
      actions.fetchSpecifications(specsUIProps.queryParams,specsUIProps.categoryId)
    );
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [specsUIProps.queryParams, dispatch, specsUIProps.categoryId]);
